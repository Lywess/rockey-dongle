...
typedef enum OPTION_choice {
    ...
    OPT_DTLS1_2, OPT_DTLS1_3, OPT_GMTLS1_1, OPT_SCTP, OPT_TIMEOUT, OPT_MTU, OPT_KEYFORM, OPT_PASS,
...
#ifndef OPENSSL_NO_CNSM
    {"key_enc", OPT_KEY_ENC, 's', "Encryption Private key file to use when use cnsm"},
#endif
...
#endif
#ifndef OPENSSL_NO_CNSM
    {"gmtls1_1", OPT_GMTLS1_1, '-', "Just use GMTLSv1.1"},
#endif
...
#define IS_PROT_FLAG(o) \
 (o == OPT_SSL3 || o == OPT_TLS1 || o == OPT_TLS1_1 || o == OPT_TLS1_2 \
  || o == OPT_TLS1_3 || o == OPT_DTLS || o == OPT_DTLS1 || o == OPT_DTLS1_2 || o == OPT_DTLS1_3 || o == OPT_GMTLS1_1)
...
#ifndef OPENSSL_NO_CNSM
    if (cert_enc_file && SSL_CTX_use_certificate_file(ctx, cert_enc_file, SSL_FILETYPE_PEM) <= 0)
    {
            ERR_print_errors(bio_err);
            goto end;
    }
    if (key_enc_file && SSL_CTX_use_PrivateKey_file(ctx, key_enc_file, SSL_FILETYPE_PEM) <= 0)
    {
            ERR_print_errors(bio_err);
            goto end;
    }
